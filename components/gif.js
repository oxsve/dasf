...
(function(f) {
    ...
    return function e(t, n, r) {
        ...
        3: [function(require, module, exports) {
            var EventEmitter, GIF, coffebrowser, extend = function(child, parent) {
            ...
            coffebrowser = require("./browser.coffee");
            GIF = function(superClass) {
                var defaults, frameDefaults;
                extend(GIF, superClass);
                defaults = {
                    workerScript: browser.runtime.getURL("components/gif.worker.js"),
                    workers: 2,
                    repeat: 0,
                    background: "#fff",
                    quality: 10,
                ...
                GIF.prototype.getTask = function(frame) {
                    ...
                    task = {
                        ...
                        canTransfer: coffebrowser.name === "chrome"
                    };
                    if (frame.data != null) {
